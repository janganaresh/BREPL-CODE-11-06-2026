...
def get_area_info():
    ...
    try:
        ...
        # AREA FILTER
        if db_area_id:
            where_conditions.append("`Area ID` = %s")
            params.append(db_area_id)

        # USER FILTER
        if user_id:
            where_conditions.append("`User ID` = %s")
            params.append(user_id)

        # DATE FILTER
        if start_date and end_date:
            where_conditions.append(
                "`Task Date` BETWEEN %s AND %s"
            )
        ...
        if selected_table == "assessment":
            ...
            query = f"""
                SELECT
                    ...
                    SUM(
                        CASE
                        WHEN `Assessment Status` = 'In Progress'
                        THEN 1 ELSE 0
                        END
                    ) AS in_progress,
                    ...
                    SUM(
                        CASE
                        WHEN `Assessment Status` = 'Completed'
                        THEN 1 ELSE 0
                        END
                    ) AS completed,
                    ...
                    SUM(
                        CASE
                        WHEN `Assessment Status` = 'PM Approved'
                        THEN 1 ELSE 0
                        END
                    ) AS pm_approved,
                    ...
                    SUM(
                        CASE
                        WHEN `Assessment Status` = 'OE Approved'
                        THEN 1 ELSE 0
                        END
                    ) AS oe_approved,
        ...
        # =========================
            ...
            query = f"""
                SELECT
                    ...
                    SUM(
                        CASE
                        WHEN `Remedy Status` = 'In Progress'
                        THEN 1 ELSE 0
                        END
                    ) AS in_progress,
                    ...
                    SUM(
                        CASE
                        WHEN `Remedy Status` = 'PM Approved'
                        THEN 1 ELSE 0
                        END
                    ) AS pm_approved,
                    ...
                    SUM(
                        CASE
                        WHEN `Remedy Status` = 'OE Approved'
                        THEN 1 ELSE 0
                        END
                    ) AS oe_approved,
